...
function clickExtendBtn(element) {
	...
	var text_extend_content = element.parentElement.getElementsByClassName("extendlen")[0];

	let url = 'cgi-bin/gen_mesh.py?url=' + activeUrl + '&extendlen=' + encodeURIComponent(text_extend_content.value)
	applyAnimation(url);
}
