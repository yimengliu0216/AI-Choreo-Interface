...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='humanml_opt.txt', split="train", **kwargs):
        self.mode = mode
        ...
        abs_base_path = '/media/yimengliu/f2154d17-caba-4946-930d-76959506ebc8/human_motion_datasets/motion_diffusion_model_dataset'
