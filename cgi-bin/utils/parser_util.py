...
def parse_and_load_from_model(parser):
    ...
    model_path = get_model_path_from_args(args)
...
def add_sampling_options(parser):
    ...
    group.add_argument("--model_path", 
                       default='/home/yimengliu/Documents/motion_generation/motion-diffusion-model/save/humanml_trans_enc_512/model000200000.pt', 
                       type=str, 
                       help="Path to model####.pt file to be sampled.")
    group.add_argument("--output_dir", default='generation_outputs', type=str,
    ...
    group.add_argument("--text_prompt", 
                       default='', 
                       type=str,
