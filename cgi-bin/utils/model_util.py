...
from model.mdm_qnanet import QnAMDM
...
def create_model_and_diffusion_quality_edit(args, data, num_joints = None):
    motion_args = get_quality_edit_model_args(args, data, num_joints)
    if args.arch == 'unet':
...
def get_quality_edit_model_args(args, data, num_joints):
    # default args
    action_emb = 'tensor'
    if args.unconstrained:
        cond_mode = 'no_cond'
